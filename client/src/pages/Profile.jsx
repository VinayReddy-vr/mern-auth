    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <p className='text-sm self-center'>
          {imageError?(<span className='text-red-600'>Error Uploading Image (file should be less than 2 MB)</span>): imagePercent >0 && imagePercent<100 ?(<span className='text-slate-700'>{`Uploading : ${imagePercent} %`}</span>): imagePercent === 100 ? (<span className='text-green-700'>Image uploaded succesfully</span>):('')}
        </p>
